# Precios TheIA — Planes y Tarifas Oficiales

> Plataforma de Agentes de Inteligencia Artificial para PYMEs y Empresas en Chile. Cobro por negocio, no por usuario. Personas del equipo incluidas sin costo extra ($0 por asiento o vendedor adicional).
...
| :--- | :--- | :--- | :--- |
| **Modelo de cobro** | **Tarifa plana por negocio** | Cobro por cada vendedor ($40–$100 USD/asiento) | Cobro por contacto activo o mensajes |
| **Costo usuarios adicionales** | **$0 CLP (Ilimitados)** | Sube tu factura cada vez que contratas | Tarifa variable impredecible |
| **Comprensión del lenguaje** | **IA contextual en lenguaje natural** | Requiere tipeo manual continuo | Menús rígidos ("presione 1, presione 2") |
| **Fidelidad de catálogo** | **Cero alucinaciones (Cerebro Empresarial)** | Manual | Respuestas genéricas o desactualizadas |
| **Intervención humana** | **Silencio automático cuando entra el vendedor** | Manual | Fricción al traspasar el chat |
| **Moneda y soporte** | **CLP local + soporte humano por WhatsApp** | Facturación en USD sin soporte local | Tickets desatendidos |
...
- **WhatsApp de Atención:** +1 (206) 385-8350
- **Ubicación:** Antonio Bellet 193, Providencia, Santiago de Chile
